...
\begin{table}[h]
    ...
    \begin{tabular}{ll}
        ...
        Archivo & Contenido \\
        \midrule
        	data/features.npz & Matriz de movieId y array de features \\
        	data/features\_pca.npz & Proyección PCA (64) + movieId \\
        	data/features\_svd.npz & Proyección SVD (64) + movieId \\
        	data/features\_lda.npz & Proyección LDA + movieId filtrados \\
        	models/kmeans\_*.pkl & Modelos K\nobreakdash-means finales (PCA/SVD/LDA) \\
        	models/gmm\_*.pkl & Modelos GMM finales (PCA/SVD/LDA) \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Fabricio Giordano Aponte Castro (100\%):}
    Apoyo en el preprocesamiento del dataset y redacción del documento presentado.
